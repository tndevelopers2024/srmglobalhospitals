...
export default function GaitTrainingArticle() {
  return (
    <>
      <script
      ...
      <ArtCover
        ...
        department="Centre for Bone, Joint & Wellness"
        date="March 31, 2026"
        readMinutes={6}
        reads="3,410"
      />
      <div className="art-wrap">
        ...
        <ArtSide
          ...
          initialToc={[
            ...
            { id: "gait-cycle", title: "The gait cycle" },
            { id: "conditions", title: "Conditions requiring gait training" },
            { id: "assessment", title: "Clinical assessment" },
            { id: "exercises", title: "Training exercises" },
            { id: "faqs", title: "FAQs" },
          ]}
          relatedReading={[
            {
