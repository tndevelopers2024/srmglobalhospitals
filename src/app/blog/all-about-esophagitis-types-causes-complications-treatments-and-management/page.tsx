...
const article = {
  ...
  description:
    "Learn about the four main types of esophagitis—reflux, eosinophilic, drug-induced, and infectious. SRM Global Hospitals gastroenterology experts detail symptoms, diagnosis, treatment, and prevention.",
  path: "/blog/all-about-esophagitis-types-causes-complications-treatments-and-management",
...
export default function EsophagitisArticle() {
  return (
    <>
      <script
      ...
      <div className="art-wrap">
        ...
        <ArtSide
          ...
          initialToc={[
            ...
            { id: "types", title: "Types of esophagitis" },
            { id: "warning-signs", title: "Warning signs" },
            { id: "complications", title: "Complications" },
            { id: "diagnosis", title: "Diagnosis and treatment" },
            { id: "faqs", title: "FAQs" },
          ]}
          relatedReading={[
            {
