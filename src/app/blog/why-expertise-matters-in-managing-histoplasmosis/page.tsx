...
export default function HistoplasmosisArticle() {
  return (
    <>
      <script
      ...
      <div className="art-wrap">
        ...
        <ArtSide
          ...
          initialToc={[
            ...
            { id: "histoplasmosis-forms", title: "Forms of histoplasmosis" },
            { id: "immunocompromised-patients", title: "Risk in immunocompromised" },
            { id: "symptoms", title: "Symptoms" },
            { id: "expert-diagnosis", title: "Diagnosis" },
            { id: "treatment-management", title: "Treatment & management" },
            { id: "risk-factors", title: "Risk factors & control" },
            { id: "faqs", title: "FAQs" },
          ]}
          relatedReading={[
            {
