...
export const metadata = createMetadata({
  title: "Clinical Excellence | SRM Global Hospitals Chennai",
  description:
    "Explore Clinical Excellence at SRM Global Hospitals Chennai, delivering advanced tertiary care in Cardiac, Neuro, Ortho, Gastro, Emergency, Women's Health, and more.",
      ...
      <main id="main-content" className="coe-page">
        <section className="hero" style={{ minHeight: "360px", padding: "80px 0 60px" }}>
          <div className="container" style={{ display: "block", textAlign: "center" }}>
            ...
            <h1 style={{ margin: "0 auto 16px" }}>Clinical Excellence</h1>
