  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/radiology/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Radiology</span>
          </div>
          <h1
          ...
          >
            Comprehensive diagnostic imaging services supporting accurate diagnosis and treatment planning across every specialty at SRM Global Hospitals.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Radiology at SRM Global Hospitals provides a full spectrum of diagnostic imaging services, including X-ray, CT, MRI, and ultrasound, to support accurate and timely diagnosis across all medical and surgical specialties.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              6 specialists in diagnostic and interventional imaging.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/radiology/image-1.png"
                  alt="Dr. Anand Alwan"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/radiology/image-2.png"
                  alt="Dr. C. Deepika"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/radiology/image-3.png"
                  alt="Dr. Karthick. K"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/radiology/image-4.png"
                  alt="Dr. Kirthi Sathyakumar"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/radiology/image-5.png"
                  alt="Dr. Senthil Kumar A"
                  width={280}
                  height={280}
                  style={{
                    width: "85%",
            ...
            {/* Dr. (Maj) Sundara Raja Perumal. R (Male) */}
            <div
              className="doctor-card"
              style={{
                background: "#faf8ff",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/radiology/image-6.png"
                  alt="Dr. (Maj) Sundara Raja Perumal. R"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
