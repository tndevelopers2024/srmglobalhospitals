  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/neurosurgery/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>NeuroSurgery</span>
          </div>
          <h1
          ...
          >
            Surgical treatment of conditions affecting the brain, spine, and nervous system, from tumors and vascular disorders to trauma and degenerative spinal disease.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of NeuroSurgery at SRM Global Hospitals specialises in the surgical management of conditions affecting the brain, spine, and peripheral nervous system, including brain tumors, cerebrovascular disorders, and degenerative and traumatic spinal conditions.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team also manages neurosurgical emergencies such as traumatic brain and spine injury and intracranial hemorrhage, working alongside allied specialities to plan safe, well-timed surgical care and support recovery for every patient.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              3 specialists in brain, spine, and nervous system surgery.
            </p>
          </div>
          ...
          >
            ...
            {/* Dr. T.P. Jeya Selva Senthilkumar (Male) */}
            <div
              className="doctor-card"
              style={{
                background: "#faf8ff",
