    ...
    <>
      ...
      <div style={{ background: "linear-gradient(135deg, #14092b 0%, #23134a 55%, #0d1b3a 100%)" }}>
        <div className="hero-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            Minimally invasive arthroscopic care for sports injuries and joint disorders, helping athletes
            and active patients return safely to movement.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Arthroscopy &amp; Sports Medicine at SRM Global Hospitals specialises in the
              diagnosis and minimally invasive surgical treatment of sports-related injuries and joint
              disorders, managing conditions affecting the shoulder, knee, and other major joints using
            ...
            >
              With expertise spanning cartilage reconstruction, ligament reconstruction, and shoulder and knee
              arthroscopy, the team combines surgical precision with structured rehabilitation planning to
              help athletes and active patients return to their sport and daily activities safely.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/arthroscopy-sports-medicine/Dr.Saseendar.jpg"
            ...
            >
              <div
                style={{
                  height: "280px",
                  background: "linear-gradient(135deg, #e7f8fc, #c9edf8)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  overflow: "hidden",
              ...
              >
                <Image
                  src="/images/departments/arthroscopy-sports-medicine/Dr.Samundeeswari.jpg"
