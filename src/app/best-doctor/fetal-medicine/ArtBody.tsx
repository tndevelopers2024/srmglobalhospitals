  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/fetal-medicine/hero.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Fetal Medicine</span>
          </div>
          <h1
          ...
          >
            Specialised prenatal diagnosis and monitoring for high-risk pregnancies, supporting expectant mothers and their babies at every stage.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Fetal Medicine at SRM Global Hospitals specialises in the diagnosis, monitoring, and management of conditions affecting the fetus during pregnancy, including detailed anomaly scans and growth assessments.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team supports women with high-risk pregnancies through close antenatal surveillance and coordinated care planning, working alongside obstetrics and other specialities whenever additional expertise is needed to guide a safe pregnancy and delivery.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Our Fetal Medicine Team
            </h2>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in prenatal diagnosis and high-risk pregnancy care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/fetal-medicine/image-1.png"
                  alt="Dr. C. Deepika"
                  width={280}
                  height={280}
                  style={{
