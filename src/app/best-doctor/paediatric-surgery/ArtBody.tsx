  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/paediatric-surgery/hero-1.avif"
            alt="Paediatric Surgery Department"
            fill
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Paediatric Surgery</span>
          </div>
          <h1
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Paediatric Surgery at SRM Global Hospitals specialises in the surgical diagnosis and management of congenital anomalies, hernias, and other conditions requiring operative treatment in infants, children, and adolescents, with techniques adapted to the smaller anatomy and physiological needs of young patients.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team works closely with paediatricians, anaesthesiologists, and neonatal specialists to plan and deliver safe surgical care, with an emphasis on minimally invasive approaches where appropriate and attentive perioperative support for children and their families.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Our Paediatric Surgery Team
            </h2>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              3 specialists in paediatric surgical care.
            </p>
          </div>
