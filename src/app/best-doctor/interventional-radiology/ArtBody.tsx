  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/interventional-radiology/hero-new.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Interventional Radiology</span>
          </div>
          <h1
          ...
          >
            Minimally invasive, image-guided diagnostic and therapeutic procedures performed using real-time X-ray, ultrasound, CT, or MRI guidance.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Interventional Radiology at SRM Global Hospitals uses advanced imaging technology to guide minimally invasive procedures that diagnose and treat a wide range of conditions without the need for open surgery. Using X-ray, ultrasound, CT, or MRI guidance, the team performs targeted procedures such as angiography, embolization, biopsies, and drainage with precision.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              These image-guided techniques typically involve smaller incisions, reduced pain, and faster recovery compared to conventional surgery, making interventional radiology an important option for both vascular and non-vascular conditions across multiple specialities.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in image-guided minimally invasive procedures.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/interventional-radiology/image-1.png"
                  alt="Dr. Mohanraj P"
                  width={280}
                  height={280}
                  style={{
