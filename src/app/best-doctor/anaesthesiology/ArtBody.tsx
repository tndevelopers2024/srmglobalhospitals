      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div
          style={{
            position: "absolute",
            inset: 0,
            left: "45%",          /* image starts at 45% from the left */
            zIndex: 0,
          }}
        >
          <Image
            src="/images/departments/anaesthesiology/hero-1.avif"
            alt="Anaesthesiology Department"
            fill
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              With nine anaesthesiologists on staff, the department covers general and regional anaesthesia, sedation for diagnostic procedures, obstetric anaesthesia, and post-operative pain management, available round the clock to support the hospital&apos;s 24/7 surgical and emergency services.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-1.png"
                  alt="Dr. Varun. C"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-2.png"
                  alt="Dr. Ksheerabdhi"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-3.png"
                  alt="Dr. Shanmitha R"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-4.png"
                  alt="Dr. K.Y. Aravindhan"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-5.png"
                  alt="Dr. Satheesh Kumar. R"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-6.png"
                  alt="Dr. Saravanan. C. R"
                  width={280}
                  height={280}
                  style={{
                    width: "95%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-7.png"
                  alt="Dr. Karthik. K"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-8.png"
                  alt="Dr. Teena Thomas"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/anaesthesiology/image-9.png"
