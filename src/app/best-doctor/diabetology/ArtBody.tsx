  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/diabetology/hero-new.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Diabetology</span>
          </div>
          <h1
          ...
          >
            Dedicated care for the diagnosis, management, and long-term monitoring of diabetes and its
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Diabetology at SRM Global Hospitals focuses on the comprehensive evaluation
              and management of Type 1 and Type 2 diabetes, prediabetes, and related metabolic conditions,
              helping patients achieve stable blood sugar control through personalised treatment plans.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team works closely with patients on medication management, regular screening for complications
              affecting the eyes, kidneys, nerves, and heart, and practical guidance on diet, exercise, and lifestyle
              changes to support long-term wellbeing.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Our Diabetology Team
            </h2>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              2 specialists in diabetes diagnosis, management, and long-term care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/diabetology/image-1.png"
                  alt="Dr. Elamthalir. I"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/diabetology/image-2.png"
