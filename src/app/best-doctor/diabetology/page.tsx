...
export const metadata = createMetadata({
  title: "Diabetology | SRM Global Hospitals",
  description:
    "Dedicated care for the diagnosis, management, and long-term monitoring of diabetes and its related complications at SRM Global Hospitals Chennai.",
  path: "/best-doctor/diabetology",
});
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Diabetology", path: "/best-doctor/diabetology" },
          ]),
        )}
      />
      <HeaderTop />
