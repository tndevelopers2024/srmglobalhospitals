  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/dermatology/hero-new.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Dermatology</span>
          </div>
          <h1
          ...
          >
            Comprehensive skin, hair, and nail care delivered by experienced dermatologists using advanced
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Dermatology at SRM Global Hospitals provides comprehensive care
              for a wide range of skin, hair, and nail conditions, from common concerns such as acne,
              eczema, and psoriasis to more complex and chronic dermatological disorders.
              The team combines careful clinical evaluation with individualised treatment planning for patients of all ages.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              Alongside medical dermatology, the department offers cosmetic and aesthetic dermatology
              services to address concerns related to skin health and appearance. Every consultation 
              is approached with an emphasis on evidence-based treatment and long-term skin, hair, and nail wellbeing.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              4 specialists in medical and cosmetic dermatology care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/dermatology/image-1.png"
                  alt="Dr. Murali Narasimhan"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
        ...
        {/* Dr. Prashanthi R */}
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/dermatology/image-3.png"
                  alt="Dr. Priya Cinna T Durai"
                  width={280}
                  height={280}
                  style={{
                    width: "70%",
            ...
            {/* Dr. G. Gnanasuriyan Ramachandran */}
            <div
              className="doctor-card"
              style={{
                background: "#faf8ff",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/dermatology/image-4.png"
                  alt="Dr. G. Gnanasuriyan Ramachandran"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
