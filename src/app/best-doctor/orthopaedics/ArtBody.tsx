  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/orthopaedics/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Orthopaedics</span>
          </div>
          <h1
          ...
          >
            Diagnosis and treatment of bone, joint, and musculoskeletal conditions, ranging from fractures and sports injuries to degenerative joint disease and joint replacement.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Orthopaedics at SRM Global Hospitals provides comprehensive care for conditions affecting the bones, joints, ligaments, and muscles, including fractures, arthritis, spinal disorders, and sports-related injuries. The team evaluates and manages both acute trauma and chronic musculoskeletal conditions across all age groups.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              Care is delivered through a combination of non-surgical management and surgical intervention, including joint replacement and fracture fixation, with treatment plans tailored to help patients regain mobility and return to their daily activities.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              7 specialists in fracture, joint, and musculoskeletal care.
            </p>
          </div>
          ...
          >
            ...
            {/* Dr. Prasad Dakshinamoorthy (Male) */}
            <div
              className="doctor-card"
              style={{
                background: "#faf8ff",
            ...
            >
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  MBBS, MS, FIJR, Fellowship in Robotic Arthroplasty
                </div>
                <div style={{ display: "flex", gap: "10px", marginTop: "auto" }}>
                  <a
                    href="tel:+919644496444"
            ...
            >
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  Visiting Consultant – Orthopaedics
                </div>
                <h3
                  style={{
                    fontFamily: "'Source Serif 4', serif",
