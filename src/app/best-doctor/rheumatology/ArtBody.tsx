  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/rheumatology/hero-2.avif"
            alt="Rheumatology Department"
            fill
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Rheumatology</span>
          </div>
          <h1
          ...
          >
            Specialised care for autoimmune and inflammatory conditions affecting the joints, muscles, and connective tissues, from diagnosis through long-term management.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Rheumatology at SRM Global Hospitals focuses on the diagnosis and management of autoimmune and inflammatory disorders affecting the joints, muscles, bones, and connective tissues, including conditions such as rheumatoid arthritis, lupus, gout, and osteoporosis.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team takes a comprehensive approach to chronic joint and autoimmune disease, combining clinical evaluation with appropriate diagnostics to guide long-term treatment plans aimed at reducing pain, preserving joint function, and improving quality of life.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              2 specialists in autoimmune and joint disease care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/rheumatology/image-1.png"
                  alt="Dr. C. Panchapakesan"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/rheumatology/image-2.png"
                  alt="Dr. Aravindhan. A"
                  width={280}
                  height={280}
                  style={{
