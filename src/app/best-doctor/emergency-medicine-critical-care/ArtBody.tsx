      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Emergency Medicine &amp; Critical Care Unit</span>
          </div>
          <h1
          ...
          >
            Round-the-clock emergency and critical care, backed by a ten-member team ready to respond the
            moment every second counts.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              Staffed by senior consultants, consultants, and visiting critical care specialists, the department
              manages trauma, cardiac emergencies, respiratory failure, and other critical conditions with
              continuous monitoring and rapid intervention, working closely with anaesthesiology and other
              departments to support patients through the ICU when intensive, ongoing care is needed.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Our Emergency Medicine &amp; Critical Care Team
            </h2>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              10 specialists providing round-the-clock emergency and critical care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-1.png"
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-2.png"
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  Senior Consultant - Emergency Medicine &amp; Critical Care
                </div>
                <h3
                  style={{
                    fontFamily: "'Source Serif 4', serif",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-3.png"
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-4.png"
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  Consultant - Emergency Medicine &amp; Critical Care
                </div>
                <h3
                  style={{
                    fontFamily: "'Source Serif 4', serif",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-5.png"
                  alt="Dr. Abdussamad"
                  width={280}
                  height={280}
                  style={{
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  Visiting Consultant - Emergency Medicine &amp; Critical Care
                </div>
                <h3
                  style={{
                    fontFamily: "'Source Serif 4', serif",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-6.png"
                  alt="Dr. Rajakali. R"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-7.png"
                  alt="Dr. Dhileeban. C.M"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-8.png"
                  alt="Dr. H. Shananth Saravanan"
                  width={280}
                  height={280}
                  style={{
                    width: "60%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-9.png"
                  alt="Dr. Raja Kantham G"
                  width={280}
                  height={280}
                  style={{
                    width: "85%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/emergency-medicine-and-critical-care/image-10.png"
                  alt="Dr. Ajay Sankar. G. R"
                  width={280}
                  height={280}
                  style={{
                    width: "70%",
