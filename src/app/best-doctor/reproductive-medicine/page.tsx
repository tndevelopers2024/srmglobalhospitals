...
export const metadata = createMetadata({
  title: "Reproductive Medicine | SRM Global Hospitals",
  description:
  ...
  path: "/best-doctor/reproductive-medicine",
});

export default function ReproductiveMedicineDepartmentPage() {
  return (
    <>
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Reproductive Medicine", path: "/best-doctor/reproductive-medicine" },
          ]),
        )}
      />
      <HeaderTop />
