  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/pulmonology/hero.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Pulmonology</span>
          </div>
          <h1
          ...
          >
            Comprehensive diagnosis and treatment of respiratory and lung conditions, from asthma and COPD to sleep-related breathing disorders.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Pulmonology at SRM Global Hospitals is dedicated to the diagnosis and management of disorders of the lungs and respiratory system, including asthma, chronic obstructive pulmonary disease (COPD), interstitial lung disease, and other chronic respiratory conditions.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              5 specialists in respiratory and lung care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/pulmonology/image-1.png"
                  alt="Dr. Sindhu. V"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/pulmonology/image-2.png"
                  alt="Dr. Aruna"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/pulmonology/image-3.png"
                  alt="Dr. Nalini Jayanthi. N"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/pulmonology/image-4.png"
                  alt="Dr. Subramanian. S"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/pulmonology/image-5.png"
                  alt="Dr. S. Pugazhendhi"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
