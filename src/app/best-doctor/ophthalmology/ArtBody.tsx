  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/ophthalmology/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Ophthalmology</span>
          </div>
          <h1
          ...
          >
            Comprehensive diagnosis and treatment of eye conditions, from routine vision care and cataract surgery to the management of glaucoma and retinal disease.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Ophthalmology at SRM Global Hospitals provides comprehensive medical and surgical eye care, diagnosing and treating a wide range of conditions including cataract, glaucoma, retinal disorders, and refractive errors. The department is equipped to manage both routine vision concerns and more complex ocular conditions requiring surgical intervention.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              Our team of ophthalmologists offers services spanning cataract surgery, glaucoma care, and general eye examinations, with a focus on preserving and restoring vision through timely diagnosis and evidence-based treatment tailored to each patient&apos;s needs.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              8 specialists in comprehensive eye care and ocular surgery.
            </p>
          </div>
          ...
          >
            ...
            {/* Dr. Aishwarya Thanasekaran. T (Female) */}
            <div
              className="doctor-card"
              style={{
                background: "#faf8ff",
