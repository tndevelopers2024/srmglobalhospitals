  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/neurology/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Neurology</span>
          </div>
          <h1
          ...
          >
            Comprehensive diagnosis and management of disorders of the brain, spinal cord, and nervous system, including stroke, epilepsy, and movement disorders.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Neurology at SRM Global Hospitals focuses on the diagnosis and treatment of conditions affecting the brain, spinal cord, and peripheral nervous system, including stroke, epilepsy, headache disorders, and movement disorders such as Parkinson&apos;s disease.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              Our consultant neurologists work through careful clinical evaluation and structured follow-up to manage acute and chronic neurological conditions, including neuromuscular and nerve-related disorders, guiding patients through diagnosis, treatment, and long-term care.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              3 specialists in the diagnosis and management of neurological disorders.
            </p>
          </div>
