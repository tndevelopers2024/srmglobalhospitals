  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/hematology/hero-new.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Hematology</span>
          </div>
          <h1
          ...
          >
            Diagnosis and management of blood disorders, from anaemia and clotting conditions to complex haematological diseases.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Hematology at SRM Global Hospitals diagnoses and manages disorders of the blood and bone marrow, including anaemia, clotting disorders, and blood-related cancers, using a combination of clinical evaluation and specialised laboratory testing.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              With expertise spanning both pathology and clinical haematology, the team develops individualised treatment plans for patients, coordinating with other specialities whenever a haematological condition is linked to a broader underlying illness.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in blood disorder diagnosis and treatment.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/hematology/image-1.png"
                  alt="Dr. D. Abinaya"
                  width={280}
                  height={280}
                  style={{
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  MBBS, MD, DNB (Pathology), DM (Clinical Haematology)
                </div>
