  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/general-surgery/hero.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>General Surgery</span>
          </div>
          <h1
          ...
          >
            Surgical care for a wide range of abdominal, gastrointestinal, and soft-tissue conditions, from elective procedures to emergency operations.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of General Surgery at SRM Global Hospitals manages a broad range of surgical conditions affecting the abdomen, gastrointestinal tract, and soft tissues, from routine elective procedures to urgent surgical emergencies.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team brings fellowship-level expertise in advanced and minimally invasive surgical techniques, working alongside anaesthesiology and critical care whenever a patient needs coordinated peri-operative support.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              4 specialists in general and minimally invasive surgery.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/general-surgery/image-1.png"
                  alt="Dr. Ajay Raja. A"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/general-surgery/image-2.png"
                  alt="Dr. Athira Gopinathan"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/general-surgery/image-3.png"
                  alt="Dr. G. Karthik"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/general-surgery/dr-ashwin-ranga.png"
                  alt="Dr. Ashwin Ranga"
                  width={280}
                  height={280}
                  style={{
