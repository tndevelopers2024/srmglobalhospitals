...
export const metadata = createMetadata({
  title: "Spine Care | SRM Global Hospitals",
  description:
  ...
  path: "/best-doctor/spine-care",
});

export default function SpineCareDepartmentPage() {
  return (
    <>
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Spine Care", path: "/best-doctor/spine-care" },
          ]),
        )}
      />
      <HeaderTop />
