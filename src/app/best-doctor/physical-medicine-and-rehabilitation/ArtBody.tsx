      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Physical Medicine and Rehabilitation</span>
          </div>
          <h1
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Physical Medicine and Rehabilitation at SRM Global Hospitals focuses on the diagnosis and non-surgical treatment of conditions that affect movement and physical function. The team works with patients recovering from stroke, injury, surgery, and other conditions that limit mobility or independence.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              Through individualised rehabilitation plans, the department helps patients regain strength, mobility, and functional independence while also managing chronic pain and long-term disability, working closely with physiotherapy and allied rehabilitation services to support recovery.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in physical medicine, rehabilitation, and functional recovery care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/physical-medicine-and-rehabilitation/image-1.png"
                  alt="Dr. Karthikeyan. R"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  Lead Consultant - Physical Medicine & Rehabilitation
                </div>
                <h3
                  style={{
                    fontFamily: "'Source Serif 4', serif",
