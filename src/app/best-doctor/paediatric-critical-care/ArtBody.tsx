      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Paediatric Critical Care</span>
          </div>
          <h1
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Paediatric Critical Care at SRM Global Hospitals provides intensive, continuous monitoring and treatment for critically ill or severely injured infants, children, and adolescents. The team manages complex conditions requiring close observation and organ support, working closely with paediatricians and paediatric surgical specialists.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              Care is delivered in a dedicated paediatric intensive care unit (PICU) environment designed around the specific physiological needs of children, with round-the-clock clinical attention and a family-centred approach to support both the child and their parents through a critical illness.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Our Paediatric Critical Care Team
            </h2>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in the intensive care of critically ill children.
            </p>
          </div>
