  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/uro-gynaecology/hero.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Uro-Gynaecology</span>
          </div>
          <h1
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Uro-Gynaecology at SRM Global Hospitals focuses on the evaluation and management of pelvic floor disorders affecting women, bringing together the combined expertise of urology and gynecology under one roof.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/uro-gynaecology/image-1.png"
