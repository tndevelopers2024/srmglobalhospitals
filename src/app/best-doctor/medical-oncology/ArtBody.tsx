  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/medical-oncology/hero-1.avif"
            alt="Medical Oncology Department"
            fill
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Medical Oncology</span>
          </div>
          <h1
          ...
          >
            Systemic cancer care using chemotherapy, targeted therapy, and immunotherapy, planned and delivered alongside surgical and radiation oncology.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Medical Oncology at SRM Global Hospitals focuses on the diagnosis and systemic treatment of cancer, using chemotherapy, targeted therapy, immunotherapy, and hormone therapy tailored to each patient&apos;s tumour type and stage.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team works closely with surgical oncology and radiation oncology colleagues as part of a coordinated, multidisciplinary approach to cancer care, ensuring treatment plans are integrated across specialities for the best possible outcome for every patient.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in systemic cancer treatment.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/medical-oncology/image-1.png"
                  alt="Dr. Karthikeyan. S"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
