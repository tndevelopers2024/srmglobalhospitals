  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/hepatology/hero-1.avif"
        ...
        >
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Hepatology</span>
          </div>
          <h1
          ...
          >
            Specialised diagnosis and management of liver disease, from chronic conditions to advanced cirrhosis care.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Hepatology at SRM Global Hospitals, part of the Institute of Gastro and Liver Sciences, specialises in diagnosing and managing conditions of the liver, from viral and fatty liver disease to chronic liver conditions and cirrhosis.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team provides ongoing monitoring and treatment planning for patients with liver disease, coordinating closely with gastroenterology and other specialities when a patient&apos;s condition calls for broader digestive or metabolic care.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              1 specialist in liver disease diagnosis and management.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/hepatology/image-1.png"
                  alt="Dr. Joy Varghese"
                  width={280}
                  height={280}
                  style={{
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  Chief Clinical Advisor - Hepatology
                </div>
                <h3
                  style={{
                    fontFamily: "'Source Serif 4', serif",
