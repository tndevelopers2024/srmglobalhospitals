  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/nephrology/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Nephrology</span>
          </div>
          <h1
          ...
          >
            Comprehensive diagnosis and management of kidney disease, from hypertension and chronic kidney disease through to dialysis care for kidney failure.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Nephrology at SRM Global Hospitals focuses on the diagnosis and management of kidney disorders, including acute kidney injury, chronic kidney disease, and hypertension arising from impaired kidney function. The team works closely with other specialities to identify underlying causes and slow disease progression through timely, evidence-based care.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              For patients with advanced kidney failure, the department provides dialysis care and ongoing renal replacement therapy, along with guidance on long-term management and, where appropriate, preparation for kidney transplantation. The goal is to support patients through every stage of kidney disease with coordinated, compassionate care.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              2 specialists in kidney disease diagnosis, management, and dialysis care.
            </p>
          </div>
