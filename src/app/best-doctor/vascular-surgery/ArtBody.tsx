  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/vascular-surgery/hero-new.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Vascular Surgery</span>
          </div>
          <h1
          ...
          >
            Comprehensive care for diseases of the arteries, veins, and lymphatic system, combining minimally invasive endovascular techniques with advanced open surgical expertise.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Vascular Surgery at SRM Global Hospitals specialises in the diagnosis and treatment of disorders affecting the arteries, veins, and lymphatic system, including aneurysms, peripheral artery disease, carotid artery disease, and varicose veins.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
            ...
            >
              The team offers both traditional open surgical techniques and minimally invasive endovascular procedures, along with dedicated dialysis access surgery, to help patients manage vascular conditions safely and effectively.
            </p>
          </div>
          <div
      ...
      <div style={{ background: "#fff" }}>
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            >
              Our Vascular Surgery Team
            </h2>
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              2 specialists in vascular and endovascular surgery care.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/vascular-surgery/image-1.png"
                  alt="Dr. Karthik Kalaiselvan"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/vascular-surgery/image-2.png"
                  alt="Dr. Arun Ezhilarasan"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
