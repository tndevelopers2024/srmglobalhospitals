  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/plastic-surgery/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Plastic Surgery</span>
          </div>
          <h1
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Plastic Surgery at SRM Global Hospitals provides comprehensive reconstructive and aesthetic surgical care, addressing defects and deformities arising from trauma, burns, congenital conditions, and cancer surgery, as well as elective cosmetic procedures.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              4 specialists in reconstructive and aesthetic plastic surgery.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/plastic-surgery/image-1.png"
                  alt="Dr. R. Santharam"
                  width={280}
                  height={280}
                  style={{
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/plastic-surgery/image-2.png"
                  alt="Dr. V.M. Arvindraj"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/plastic-surgery/image-3.png"
                  alt="Dr. Arun Prasath. S"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/plastic-surgery/image-4.png"
                  alt="Dr. S. Satish Kumar"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
