  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/physiotherapy/hero-1.avif"
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Physiotherapy</span>
          </div>
          <h1
          ...
          >
            Restoring movement and function through exercise-based therapy, manual therapy, and structured rehabilitation for patients of all ages.
          </p>
        </div>
      </div>
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The Department of Physiotherapy at SRM Global Hospitals focuses on the assessment and rehabilitation of movement disorders using exercise, manual therapy, and other physical techniques. The team works closely with patients recovering from injury, surgery, or illness to help restore strength, mobility, and independence.
            </p>
            <p
              style={{
                fontFamily: "Inter, sans-serif",
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              Dedicated therapists supporting your recovery.
            </p>
          </div>
