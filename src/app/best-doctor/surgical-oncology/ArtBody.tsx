  ...
  return (
    <>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <Image
            src="/images/departments/surgical-oncology/hero-1.avif"
            alt="Surgical Oncology Department"
            fill
        ...
        <div className="hero-inner" style={{ position: "relative", zIndex: 2, maxWidth: "1200px", margin: "0 auto", padding: "80px 40px 60px" }}>
          ...
          >
            ...
            <span style={{ opacity: 0.4 }}>›</span>
            <span style={{ color: "rgba(255, 255, 255, 0.85)" }}>Surgical Oncology</span>
          </div>
          <h1
      ...
      <div className="overview-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
        ...
        >
          <div>
            ...
            >
              The team works closely with medical and radiation oncology specialists as part of a coordinated, multidisciplinary approach to cancer care, aiming to deliver safe, effective surgical outcomes alongside comprehensive treatment planning.
            </p>
          </div>
          <div
        ...
        <div className="doctors-inner" style={{ maxWidth: "1200px", margin: "0 auto", padding: "80px 40px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            ...
            <p style={{ fontFamily: "Inter, sans-serif", fontSize: "15px", color: "#888", margin: 0 }}>
              2 specialists in surgical oncology and complex cancer surgery.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/surgical-oncology/image-1.png"
                  alt="Dr. Kishore Kumar K"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
              ...
              <div style={{ padding: "24px", display: "flex", flexDirection: "column", flex: 1 }}>
                ...
                >
                  MBBS, MS (General Surgery), DrNB (Surgical Oncology), FIAGES, FALS (Oncology)
                </div>
            ...
            >
              ...
              >
                <Image
                  src="/images/departments/surgical-oncology/image-2.png"
                  alt="Dr. Gerald Anand Raja"
                  width={280}
                  height={280}
                  style={{
                    width: "75%",
