...
export const metadata = createMetadata({
  title: "Best Vascular Surgery Hospital in Chengalpattu | SRM Global Hospitals",
  description: "",
  path: "/specialties/vascular-surgery",
});
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Department of Vascular Surgery", path: "/specialties/vascular-surgery" },
          ]),
        )}
      />
      <HeaderTop />
