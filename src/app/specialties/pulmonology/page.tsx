...
export const metadata = createMetadata({
  title: "Department of Pulmonology | SRM Global Hospitals",
  description:
    "Our pulmonology team offers comprehensive care for all respiratory conditions, from diagnosis through treatment and long-term management, using the latest ...",
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Department of Pulmonology", path: "/specialties/pulmonology" },
          ]),
        )}
      />
      <HeaderTop />
