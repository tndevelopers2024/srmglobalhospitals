...
export const metadata = createMetadata({
  title: "Best Surgical Oncology Hospital in Chengalpattu | SRM Global Hospitals",
  description: "",
  path: "/specialties/surgical-oncology",
});
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Department of Surgical Oncology", path: "/specialties/surgical-oncology" },
          ]),
        )}
      />
      <HeaderTop />
