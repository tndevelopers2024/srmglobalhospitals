...
export const metadata = createMetadata({
  title: "Best Spine Care Hospital in Chengalpattu | SRM Global Hospitals",
  description: "",
  path: "/specialties/spine-care",
});
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Department of Spine Care", path: "/specialties/spine-care" },
          ]),
        )}
      />
      <HeaderTop />
