...
export const metadata = createMetadata({
  title: "Best Uro-Gynaecology Hospital in Chengalpattu | SRM Global Hospitals",
  description: "",
  path: "/specialties/uro-gynaecology",
});
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Department of Uro-Gynaecology", path: "/specialties/uro-gynaecology" },
          ]),
        )}
      />
      <HeaderTop />
