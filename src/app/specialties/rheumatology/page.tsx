...
export const metadata = createMetadata({
  title: "Best Rheumatology Hospital in Chengalpattu | SRM Global Hospitals",
  description: "",
  path: "/specialties/rheumatology",
});
      ...
      <script
        ...
        {...jsonLdScriptProps(
          breadcrumbSchema([
            ...
            { name: "Department of Rheumatology", path: "/specialties/rheumatology" },
          ]),
        )}
      />
      <HeaderTop />
